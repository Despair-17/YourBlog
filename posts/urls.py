...
urlpatterns = [
    ...
    path('my-posts/', views.MyPostsCreateView.as_view(), name='my_posts'),
    path('post/<slug:post_slug>/', views.PostDetailView.as_view(), name='post'),
    path('update_post/<slug:post_slug>', views.MyPostsUpdateView.as_view(), name='update_post'),
    path('delete_psot/<slug:post_slug>', views.MyPostsDeleteView.as_view(), name='delete_post'),
]
